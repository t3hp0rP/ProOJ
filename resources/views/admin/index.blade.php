            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @if (!Auth::guard('admin')->check())
                        <li><a class="menu" href="{{ route('admin.login') }}">Login</a></li>
                    @else
                        <li><a href="{{ route('admin.dashboard') }}" class="menu">Home</a></li>
                        <li class="dropdown">
...
<script src="{{ asset('js/adminAddition.js') }}"></script>
</body>
</html>